import 'lost_item_response.dart';
...
class BookingDetailBody {
  ...
  BookingDetailBody.fromJson(dynamic json) {
    ...
    destinationLatitude = json['destinationLatitude']?.toString();
    destinationLongitude = json['destinationLongitude']?.toString();
    status = json['status'];
    amount = json['amount'];
    distance = json['distance'];
    typeOfVehicleId = json['typeOfVehicleId']?.toString();
    ...
    reason = json['reason'];
    bookingRejectCount = json['bookingRejectCount'];
    user = json['user'] != null ? User.fromJson(json['user']) : null;
    driver = json['driver'] != null ? User.fromJson(json['driver']) : null;
    lostItem = json['lostItem'] != null ? LostItem.fromJson(json['lostItem']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['reason'] = reason;
    map['bookingRejectCount'] = bookingRejectCount;
    if (user != null) {
