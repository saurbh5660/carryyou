class ApiConstants {
  ...
  static const String getVehiclePrice = "$_baseUrl/users/getPriceListWithVechile";
  static const String createBooking = "$_baseUrl/users/createBooking";
  static const String bookingConfirmation = "$_baseUrl/users/webHookFrontEnd";
  ...
  static const String ratingDriver = "$_baseUrl/users/ratingDriver";
  static const String submitLostItemRequestDriver = "$_baseUrl/users/submitLostItemRequestDriver";
  static const String driverFoundItemConfimByUser = "$_baseUrl/users/driverFoundItemConfimByUser";
  static const String sendRequestToAdminByUser = "$_baseUrl/users/sendRequestToAdminByUser";
  static const String payAmountLostItem = "$_baseUrl/users/payAmountStripeForLostItem";
  static const String webHookFrontEndLostItem = "$_baseUrl/users/webHookFrontEndLostItem";
  static const String applyCouponCode = "$_baseUrl/users/applyCouponCode";
  ...
  static const String couponCodeList = "$_baseUrl/users/couponCodeList";
  static const String deleteAccount = "$_baseUrl/users/deleteUser";
  static const String bannerList = "$_baseUrl/users/bannerList";
  static const String reviewsListing = "$_baseUrl/users/reviewsListing";
  ...
  static const String notificationList = "$_baseUrl/notificationlist";
  static const String getEmployees = "$_baseUrl/all_employees";
  static const String getEmployeesGet = "$_baseUrl/all_employe_get";
  static const String createRoute = "$_baseUrl/create_routes";
  static const String report = "$_baseUrl/report";
  static const String home = "$_baseUrl/home";
  static const String employeeList = "$_baseUrl/employe_list";
  static const String scheduleDetail = "$_baseUrl/schedule_details";
  static const String currentPast = "$_baseUrl/current_past";
  static const String stopDetail = "$_baseUrl/stop_detail";
  static const String getProfile = "$_baseUrl/getprofile";
  static const String editProfile = "$_baseUrl/editprofile";
  static const String generatePdf = "$_baseUrl/generate_pdf";
  static const String faq = "$_baseUrl/faq";
  static const String createTask = "$_baseUrl/create_task";
